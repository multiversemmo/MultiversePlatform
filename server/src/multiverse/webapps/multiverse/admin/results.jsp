...
<%
    ...
    if(searchString.length() == 0) {
        query = "SELECT username, email FROM user LIMIT 200";        
    }
    else
    {
        query = "SELECT username, email FROM user WHERE username LIKE '%" +
                searchString +
                "%' LIMIT 200";
    }
...
<tr>
<td></td><td><input type="button" value="Add User"
...
<tr>
<td><a href="edit.jsp?username=<%= username %>"><%= username %></a></td>
<td><%= password %></td>
</tr>
