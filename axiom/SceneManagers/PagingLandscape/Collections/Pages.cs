...
using T = Axiom.SceneManagers.PagingLandscape.Collections.PageRow;
...

{
	...
	public class Pages : UnsortedCollection 

	{
		...
		public Pages(int Capacity) : base(Capacity) {}

		public Pages(object Parent) : base(Parent) {}

		public Pages(object Parent, int Capacity) : base(Parent, Capacity) {}
