...
using T = Axiom.SceneManagers.PagingLandscape.Collections.TileRow;
...

{
	...
	public class Tiles : UnsortedCollection 

	{
		...
		public Tiles(int Capacity) : base(Capacity) {}

		public Tiles(object Parent) : base(Parent) {}

		public Tiles(object Parent, int Capacity) : base(Parent, Capacity) {}
