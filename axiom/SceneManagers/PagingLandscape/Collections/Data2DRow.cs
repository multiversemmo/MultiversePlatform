...
using T = Axiom.SceneManagers.PagingLandscape.Data2D.Data2D;
...

{
	...
	public class Data2DRow : UnsortedCollection 

	{
		...
		public Data2DRow() : base() {}

		public Data2DRow(int Capacity) : base(Capacity) {}

		public Data2DRow(object Parent) : base(Parent) {}

		public Data2DRow(object Parent, int Capacity) : base(Parent, Capacity) {}
