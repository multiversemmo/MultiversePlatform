...
using T = Axiom.SceneManagers.PagingLandscape.Tile.Tile;
...

{
	...
	public class TileRow : UnsortedCollection 

	{
		...
		public TileRow(int Capacity) : base(Capacity) {}

		public TileRow(object Parent) : base(Parent) {}

		public TileRow(object Parent, int Capacity) : base(Parent, Capacity) {}
